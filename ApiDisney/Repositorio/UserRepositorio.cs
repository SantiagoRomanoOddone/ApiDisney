...
namespace ApiDisney.Repositorio
{
    public class UserRepositorio : IUserRepositorio
    {
        ...
        public UserRepositorio (DisneyDbContext db, IConfiguration configuration)
        {
            _db = db;
        ...
        public async Task<string> Login(string userName, string password)
        {
            ...
            else if (!PasswordHashVerification(password, user.PasswordHash, user.PasswordSalt))
            {
        ...
        public bool PasswordHashVerification (string password, byte[] passwordHash, byte[] passwordSalt)
        {
